...
<header>
	<div id="header-container">
		...
		<h4><?php echo $lang['LANGUAGE_MENU']; ?></h4>
			<div id="select" >
			    <div id="english" value="english" class="language-select"><a href="request.php?lang=en"><p>English</p></a></div>
			    <div id="spanish" value="spanish"  class="language-select"><a href="request.php?lang=bg"><p>Български</p></a></div>
			    <div id="spanish" value="spanish"  class="language-select"><a href="request.php?lang=rus"><p>Русский</p></a></div>
			</div>
		</div>
...
<aside>  
 <input id="toggle" type="checkbox">
  <div class="slide-menu">
    ...
    <nav class="menu">
      <li><form id="mini_search" action="result_main.php" method="POST"><label id="icons-menu-search" name="Search bar" ><button class="fa fa-search"></button></label>
      <input type="search" autocomplete="off" name="search" placeholder="<?php echo $lang['SEARCH']; ?>"  class="search-input"></input>
      					<div id="here"></div>
					<div class="box"><input  type="radio" name="option" value="sub">Subject<br></div>
					<div class="box"><input  type="radio" name="option" value="top">Topic<br></div>
...
<main type="context">
	<div id="main-container">
		<div id="support">
			...
			<p><?php echo $lang['EXPLAIN_SUPPORT'];?></p>
			<form id="hideForfottenForm" class="forget-form" action="support_function.php" method="post">
				<textarea name="content" id="support_textarea"></textarea> 
				<input type="submit" id="submit_request_btn" name="submit_request" value="Submit"></input>
			</form>
		</div>
</div>
</main>
