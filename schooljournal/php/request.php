...
<main type="context">
	<div id="main-container">
		<div id="request">
			...
			<p><?php echo $lang['EXPLAIN'];?></p>
			<form id="hideForfottenForm" class="forget-form" action="request_function.php" method="post">
				<textarea name="content" id="request_textarea"></textarea> 
