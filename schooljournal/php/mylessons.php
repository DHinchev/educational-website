...
<header>
	<div id="header-container">
		...
		<h4><?php echo $lang['LANGUAGE_MENU']; ?></h4>
			<div id="select" >
			    <div class="language-select"><a href="mylessons.php?lang=en"><p>English</p></a></div>
			    <div class="language-select"><a href="mylessons.php?lang=bg"><p>Български</p></a></div>
			    <div class="language-select"><a href="mylessons.php?lang=rus"><p>Русский</p></a></div>
			</div>
		</div>
 ...
 <input id="toggle" type="checkbox">
  <div class="slide-menu">
    ...
    <nav class="menu">
      ...
      <li><label id="icons-menu-profile" name="Profile"><a class="icon-link" href="myprofile.php"><i class="fa fa-user"></i></a></label><a href="myprofile.php"><?php echo $lang['MENU_PROFILE']; ?></a></li>
