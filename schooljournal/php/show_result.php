...
<main>
	<div id="main-container">
	      	...
	      	echo " <div class='add'><a href='/schooljournal/php/editor.php?".$q."=".$n."'>".$lang['ADD_LESSONS']."</a><label id='add_lesson' name='Add'><i class='fa fa-plus'></i></label></div>";
	      	} 
	      		if($separated == 'student'){
	      			if($_GET){
			      		$ro = $_SERVER['QUERY_STRING'];
			      		$x = explode("=",$ro);
			      	    $q = $x[0];
