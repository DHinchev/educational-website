...
$searchOpMain = $_SESSION['searchtypemain'];
...
<div id="header-container">
	...
	<h4><?php echo $lang['LANGUAGE_MENU']; ?></h4>
		<div id="select" >
		    <div class="language-select"><a href="result_main.php?lang=en"><p>English</p></a></div>
		    <div class="language-select"><a href="result_main.php?lang=bg"><p>Български</p></a></div>
		    <div class="language-select"><a href="result_main.php?lang=rus"><p>Русский</p></a></div>
		</div>
	</div>
...
<div id="main-container_result">
<h2><?php echo $lang['RESULTS']; ?></h2>

<?php
echo "<div class='results_main'>";
		if ($searchOpMain =='user'){

			foreach($_SESSION['outputuser'] as $value){
    			echo $value;
			}
		}
		...
		if ($searchOpMain =='sub'){
			...
			foreach($_SESSION['outputsub'] as $value){
    			echo $value;
			}
		}
		...
		if ($searchOpMain =='top'){
			...
			foreach($_SESSION['outputtop'] as $value){
    			echo $value;
			}
		}
		...
		if ($searchOpMain ==''){
			...
			foreach($_SESSION['outputall'] as $value){
    			echo $value;
			}
		}
