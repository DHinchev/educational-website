...
<header>
	<div id="header-container">
		...
		<h4><?php echo $lang['LANGUAGE_MENU']; ?></h4>
			<div id="select" >
			    <div class="language-select"><a href="myprofile.php?lang=en"><p>English</p></a></div>
			    <div class="language-select"><a href="myprofile.php?lang=bg"><p>Български</p></a></div>
			    <div class="language-select"><a href="myprofile.php?lang=rus"><p>Русский</p></a></div>
			</div>
		</div>
...
<main type="context">
	<div id="main-container">
		<div id="profile">
			<h3><?php echo $lang['YOUR_PROFILE'];?></h3>
			<p><?php echo $lang['USERNAME'] ?>:<?php echo $username;?></p>
			<p><?php echo $lang['CHANG_PASSWORD'] ?></p>
			<form id="change_form_password" action="re_myprofile.php" method="POST">
				<input type="password" name="change_password" placeholder="New password here"></input>
				<input type="submit" name="change_password_submit" value="New password"></input>
			</form>
			<p><?php echo $lang['EMAIL'] ?>:<?php
			 ...
			 ;?></p>
			<form id="change_form_email" action="re_myprofile.php" method="POST">
				<input id="change_email" type="text" name="change_email" placeholder="New email here"></input>
				<input type="submit" name="change_email_submit" value="New email"></input>
				<span id='messageEmail'></span>
			</form>

			<p>Status:<?php echo $separated;?></p>
		</div>
	</div>
</main>
...
<script src="../scripts/ProfileValidation.js" type="text/javascript"></script>
